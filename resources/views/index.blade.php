                ...
                <div class="container">
                    <div class="hb-group d-flex align-items-center justify-content-between">
                        ...
                        <div class="header-btn d-inline-block">
                            <a href="https://1.envato.market/Nkdz7q" class="button-round-secondary">MASUK</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="about-right-content">
                        ...
                        <figure class="figure-round-border mb-3">
                            <img style="height: 400px; object-fit: cover;" src="assets/img/detail-banner.webp"
                                alt="Detail Banner">
                        </figure>
                            ...
                            <div class="inner-goal-image">
                                <figure class="video-play-image">
                                    <img style="width: 100%; height: 300px; object-fit: cover;"
                                        src="assets/img/bg_youtube.webp" alt="Background Youtube">
                                </figure>
                            </div>
                        </div>
                        <div class="col-lg-5">
                                ...
                                <div class="author-content">
                                    <div>
                                        <figure class="author-img">
                                            <img src="assets/img/profil_${item.jenis_kelamin}.svg" alt="">
                                        </figure>
                                    </div>
